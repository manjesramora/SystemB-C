                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    ...
                                    <h3 class="font-weight-light my-4">SYSTEMA B&C LOGIN</h3>
                                </div>
                                <div class="card-body">
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            <label class="small mb-1" for="usuario"><i class="fas fa-user"></i> Nombre de Usuario</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" id="clave" name="clave" type="password" placeholder="Contraseña" required />
                                        </div>
